...
#取某天
risk.data.all <- sqlQuery(channel, paste('select * from thbl.risk_statistics_all where data_dt = to_date(\'', current.date,'\',\'YYYYMMDD\') and prov_cd not like \'35%\'')) 
...
template <- paste0("E:\\Allinpay\\Data\\TeamWork\\dataForReport\\daily_bisRpts_exp_", Sys.Date(), ".xls")
